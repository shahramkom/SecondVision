...
typedef std::conditional<sizeof(int) >= sizeof(double), int, double>::type Type3; //double

typedef std::conditional<true, int, float>::type Atp;                      // int
typedef std::conditional<false, int, float>::type Btp;                     // float
typedef std::conditional<std::is_integral<A>::value, long, int>::type Ctp; // long
typedef std::conditional<std::is_integral<B>::value, long, int>::type Dtp; // int
...
struct ACX { };
struct BCX : ACX {};
struct CCX { CCX& operator= (const ACX&) { return *this; } };

class AM {};
class BM { BM() {} };
class CM : BM {};
class DM { virtual void fn() {} };

struct AE { };
struct BE { BE& operator= (const BE&) = delete; };
#pragma endregion is_trivially

#pragma region is_assignable
struct AL { };
struct BL { BL& operator= (const AL&) { return *this; } };
...
#pragma region underlying_type
	...
	std::cout << "\ntypedefs of int:" << std::endl;
	std::cout << "ASP_under: " << std::is_same<int, ASP_under>::value << std::endl;
	std::cout << "BSP_under: " << std::is_same<int, BSP_under>::value << std::endl;
...
#pragma region is_trivially
	...
	std::cout << "int=short: " << std::is_trivially_copy_assignable<int>::value << std::endl;
	std::cout << "A=A: " << std::is_trivially_copy_assignable<ACX>::value << std::endl;
	std::cout << "A=B: " << std::is_trivially_copy_assignable<ACX>::value << std::endl;
	std::cout << "B=A: " << std::is_trivially_copy_assignable<BCX>::value << std::endl;
	std::cout << "C=A: " << std::is_trivially_copy_assignable<CCX>::value << std::endl;

	std::cout << "\nis_trivially_move_assignable:" << std::endl;
	std::cout << "int=short: " << std::is_trivially_move_assignable<int>::value << std::endl;
	std::cout << "A=A: " << std::is_trivially_move_assignable<AT>::value << std::endl;
	std::cout << "B=A: " << std::is_trivially_move_assignable<BT>::value << std::endl;
...
#pragma region is_assignable
	...
	std::cout << "int: " << std::is_copy_assignable<int>::value << std::endl; //int: true
	std::cout << "A: " << std::is_copy_assignable<AE>::value << std::endl;     //A: true
	std::cout << "B: " << std::is_copy_assignable<BE>::value << std::endl;     //B: true


	std::cout << "\nis_assignable:" << std::endl;
	std::cout << "A=B: " << std::is_assignable<AL, BL>::value << std::endl;  //A=B: false
